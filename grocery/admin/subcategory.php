...
if(isset($_POST['submit']))
{
	...
	$c="select subcategory from subcategory where subcategory='$subcat'";
	$cc=mysqli_query($con,$c);
	
	
	if(empty($subcat)){
		$errors['c']="Subcategory Requires";
	}else if(mysqli_num_rows($cc) > 0){
		$errors['c']="Subcategory Exist";
	}
...
<div class="controls">
<input type="text" placeholder="Enter SubCategory Name"  name="subcategory" class="span8 tip" >

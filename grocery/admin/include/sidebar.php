...
<?php } ?>
						...
						<ul class="widget widget-menu unstyled">
							...
							<li><a href="contact.php"><i class="menu-icon icon-group"></i>Show Contact </a></li>
							
							<li><a href="reviews.php"><i class="menu-icon icon-group"></i>Manage Products Reviews </a></li>
